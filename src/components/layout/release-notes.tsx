...
import { APP_VERSION, RELEASES, releaseNotes, type Release } from '@/lib/releases';

/** The per-release sections — shared by the footer pane and the "What's new" popup. */
export function ReleaseNotesList({ releases }: { releases: readonly Release[] }) {
